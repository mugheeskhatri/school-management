   ...
   setNewStudent(
    {
      ...
      contatNumber: studentData[0].contatNumber,
      fatherNic: studentData[0].fatherNic,
      bForm: studentData[0].bForm,
      studentClass: studentData[0].studentClass,
      fatherContatNumber: studentData[0].fatherContatNumber,
      lastQualification: studentData[0].fatherContatNumber,
      gender: studentData[0].gender,
      grNumber: studentData[0].grNumber,
      status: studentData[0].status,
      date: studentData[0].date,
    }
   )
        ...
        <>
          ...
          <div className='form-container'>
            ...
            <div className='width'>
              ...
              <div className="mt-4 mb-4">
                <Button onClick={() => handleSubmit()}>Edit Student</Button>
              </div>
            </div>
            <div className='width'>
              <div className='form-id-card'>
